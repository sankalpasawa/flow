...
function buildActivities(): { activities: SeedActivity[]; logs: SeedLog[] } {
  ...
  activities.push(
    { id: uuid(), title: 'Morning water', start_time: isoAt(-7, 7, 57), duration_minutes: 10, category_id: 'sys-personal', activity_type: 'TIME_BLOCK', assigned_date: null, is_scheduled: true, status: 'COMPLETED', priority: 'MEDIUM', recurrence_type: 'WEEKLY', mindset_prompt: 'Hydrate before anything. Start the day clean.', actual_start: isoAt(-7, 7, 57), actual_end: isoAt(-7, 8, 7) },
    { id: uuid(), title: 'Breakfast', start_time: isoAt(-7, 8, 31), duration_minutes: 30, category_id: 'sys-personal', activity_type: 'TIME_BLOCK', assigned_date: null, is_scheduled: true, status: 'COMPLETED', priority: 'MEDIUM', recurrence_type: 'WEEKLY', mindset_prompt: 'Be grateful for the food. Eat slowly.', actual_start: isoAt(-7, 8, 31), actual_end: isoAt(-7, 9, 0) },
    { id: uuid(), title: 'Waking up practise', start_time: isoAt(-7, 9, 0), duration_minutes: 20, category_id: 'sys-personal', activity_type: 'TIME_BLOCK', assigned_date: null, is_scheduled: true, status: 'COMPLETED', priority: 'MEDIUM', recurrence_type: 'WEEKLY', mindset_prompt: 'Feel the energy. Affirmations of loving self.', actual_start: isoAt(-7, 9, 0), actual_end: isoAt(-7, 9, 20) },
    { id: uuid(), title: 'Sunlight', start_time: isoAt(-7, 9, 0), duration_minutes: 15, category_id: 'sys-health', activity_type: 'TIME_BLOCK', assigned_date: null, is_scheduled: true, status: 'COMPLETED', priority: 'HIGH', recurrence_type: 'WEEKLY', mindset_prompt: '15 minutes of warmth. Let the light reset your body.', actual_start: isoAt(-7, 9, 0), actual_end: isoAt(-7, 9, 15) },
    { id: uuid(), title: 'Self love', start_time: isoAt(-7, 10, 0), duration_minutes: 30, category_id: 'sys-personal', activity_type: 'TIME_BLOCK', assigned_date: null, is_scheduled: true, status: 'COMPLETED', priority: 'HIGH', recurrence_type: 'WEEKLY', mindset_prompt: 'I am enough and I love the way I am.', actual_start: isoAt(-7, 10, 0), actual_end: isoAt(-7, 10, 30) },
    ...
    { id: uuid(), title: 'Leisure activities', start_time: isoAt(-7, 15, 0), duration_minutes: 60, category_id: 'sys-rest', activity_type: 'TIME_BLOCK', assigned_date: null, is_scheduled: true, status: 'COMPLETED', priority: 'LOW', recurrence_type: 'DAILY', mindset_prompt: 'This is one of my first callings. Just enjoy it.', actual_start: isoAt(-7, 15, 0), actual_end: isoAt(-7, 16, 0) },
    { id: uuid(), title: 'Celebrating Journal', start_time: isoAt(-7, 20, 0), duration_minutes: 20, category_id: 'sys-personal', activity_type: 'TIME_BLOCK', assigned_date: null, is_scheduled: true, status: 'COMPLETED', priority: 'MEDIUM', recurrence_type: 'WEEKLY', mindset_prompt: 'Grateful for the small wins this week.', actual_start: isoAt(-7, 20, 0), actual_end: isoAt(-7, 20, 20) },
    { id: uuid(), title: 'Check routine before sleep', start_time: isoAt(-7, 21, 0), duration_minutes: 15, category_id: 'sys-personal', activity_type: 'TIME_BLOCK', assigned_date: null, is_scheduled: true, status: 'COMPLETED', priority: 'MEDIUM', recurrence_type: 'BIWEEKLY', mindset_prompt: 'Review the day. What went well?', actual_start: isoAt(-7, 21, 0), actual_end: isoAt(-7, 21, 15) },
  ...
  activities.push(
    { id: uuid(), title: 'Morning water', start_time: isoAt(-6, 7, 57), duration_minutes: 10, category_id: 'sys-personal', activity_type: 'TIME_BLOCK', assigned_date: null, is_scheduled: true, status: 'COMPLETED', priority: 'MEDIUM', recurrence_type: 'WEEKLY', mindset_prompt: 'Hydrate before anything. Start the day clean.', actual_start: isoAt(-6, 7, 57), actual_end: isoAt(-6, 8, 7) },
    { id: uuid(), title: 'Read about Vata', start_time: isoAt(-6, 9, 0), duration_minutes: 45, category_id: 'sys-learning', activity_type: 'TIME_BLOCK', assigned_date: null, is_scheduled: true, status: 'COMPLETED', priority: 'MEDIUM', recurrence_type: 'NONE', mindset_prompt: 'Knowledge is power. Stay curious.', actual_start: isoAt(-6, 9, 0), actual_end: isoAt(-6, 9, 45) },
    { id: uuid(), title: 'Love/care with bhabhi', start_time: isoAt(-6, 10, 0), duration_minutes: 30, category_id: 'cust-family', activity_type: 'TIME_BLOCK', assigned_date: null, is_scheduled: true, status: 'COMPLETED', priority: 'HIGH', recurrence_type: 'WEEKLY', mindset_prompt: 'Be present. Listen. Don\'t give advice.', actual_start: isoAt(-6, 10, 0), actual_end: isoAt(-6, 10, 30) },
    { id: uuid(), title: 'Sankalp work', start_time: isoAt(-6, 11, 0), duration_minutes: 150, category_id: 'sys-deep-work', activity_type: 'TIME_BLOCK', assigned_date: null, is_scheduled: true, status: 'COMPLETED', priority: 'HIGH', recurrence_type: 'WEEKLY', mindset_prompt: 'Serious about intent, playful execution.', actual_start: isoAt(-6, 11, 0), actual_end: isoAt(-6, 13, 30) },
    { id: uuid(), title: 'Create happy memories', start_time: isoAt(-6, 16, 0), duration_minutes: 60, category_id: 'sys-personal', activity_type: 'TIME_BLOCK', assigned_date: null, is_scheduled: true, status: 'COMPLETED', priority: 'MEDIUM', recurrence_type: 'WEEKLY', mindset_prompt: 'Make someone smile today.', actual_start: isoAt(-6, 16, 0), actual_end: isoAt(-6, 17, 0) },
    { id: uuid(), title: 'Read 5 aesop', start_time: isoAt(-6, 20, 0), duration_minutes: 30, category_id: 'sys-learning', activity_type: 'TIME_BLOCK', assigned_date: null, is_scheduled: true, status: 'COMPLETED', priority: 'LOW', recurrence_type: 'NONE', mindset_prompt: 'Strategy reading. Mindset of control.', actual_start: isoAt(-6, 20, 0), actual_end: isoAt(-6, 20, 30) },
  ...
  activities.push(
    { id: uuid(), title: 'Sunlight', start_time: isoAt(-5, 9, 0), duration_minutes: 15, category_id: 'sys-health', activity_type: 'TIME_BLOCK', assigned_date: null, is_scheduled: true, status: 'COMPLETED', priority: 'HIGH', recurrence_type: 'WEEKLY', mindset_prompt: '15 minutes of warmth. Let the light reset your body.', actual_start: isoAt(-5, 9, 0), actual_end: isoAt(-5, 9, 15) },
    { id: uuid(), title: 'Waking up practise', start_time: isoAt(-5, 9, 15), duration_minutes: 20, category_id: 'sys-personal', activity_type: 'TIME_BLOCK', assigned_date: null, is_scheduled: true, status: 'COMPLETED', priority: 'MEDIUM', recurrence_type: 'WEEKLY', mindset_prompt: 'Feel the energy. Affirmations of loving self.', actual_start: isoAt(-5, 9, 15), actual_end: isoAt(-5, 9, 35) },
    { id: uuid(), title: 'Bhaiya meet', start_time: isoAt(-5, 15, 0), duration_minutes: 60, category_id: 'cust-family', activity_type: 'TIME_BLOCK', assigned_date: null, is_scheduled: true, status: 'COMPLETED', priority: 'HIGH', recurrence_type: 'WEEKLY', mindset_prompt: 'Be equal. No one is above or below.', actual_start: isoAt(-5, 15, 0), actual_end: isoAt(-5, 16, 0) },
    { id: uuid(), title: 'Humour Writing', start_time: isoAt(-5, 17, 0), duration_minutes: 45, category_id: 'sys-creative', activity_type: 'TIME_BLOCK', assigned_date: null, is_scheduled: true, status: 'COMPLETED', priority: 'MEDIUM', recurrence_type: 'WEEKLY', mindset_prompt: 'Make situations lighter. Improv.', actual_start: isoAt(-5, 17, 0), actual_end: isoAt(-5, 17, 45) },
  ...
  activities.push(
    { id: uuid(), title: 'Breakfast', start_time: isoAt(-4, 8, 30), duration_minutes: 30, category_id: 'sys-personal', activity_type: 'TIME_BLOCK', assigned_date: null, is_scheduled: true, status: 'COMPLETED', priority: 'MEDIUM', recurrence_type: 'WEEKLY', mindset_prompt: 'Be grateful for the food. Eat slowly.', actual_start: isoAt(-4, 8, 30), actual_end: isoAt(-4, 9, 0) },
    ...
    { id: uuid(), title: 'Leisure activities', start_time: isoAt(-4, 20, 0), duration_minutes: 60, category_id: 'sys-rest', activity_type: 'TIME_BLOCK', assigned_date: null, is_scheduled: true, status: 'COMPLETED', priority: 'LOW', recurrence_type: 'DAILY', mindset_prompt: 'This is one of my first callings. Just enjoy it.', actual_start: isoAt(-4, 20, 0), actual_end: isoAt(-4, 21, 0) },
  );
  logs.push(
  ...
  activities.push(
    { id: uuid(), title: 'Morning water', start_time: isoAt(-3, 7, 57), duration_minutes: 10, category_id: 'sys-personal', activity_type: 'TIME_BLOCK', assigned_date: null, is_scheduled: true, status: 'COMPLETED', priority: 'MEDIUM', recurrence_type: 'WEEKLY', mindset_prompt: 'Hydrate before anything. Start the day clean.', actual_start: isoAt(-3, 7, 57), actual_end: isoAt(-3, 8, 7) },
    { id: uuid(), title: 'Sankalp work', start_time: isoAt(-3, 10, 0), duration_minutes: 120, category_id: 'sys-deep-work', activity_type: 'TIME_BLOCK', assigned_date: null, is_scheduled: true, status: 'COMPLETED', priority: 'HIGH', recurrence_type: 'WEEKLY', mindset_prompt: 'Serious about intent, playful execution.', actual_start: isoAt(-3, 10, 0), actual_end: isoAt(-3, 12, 0) },
  ...
  activities.push(
    ...
    { id: uuid(), title: 'Check routine before sleep', start_time: isoAt(-2, 21, 0), duration_minutes: 15, category_id: 'sys-personal', activity_type: 'TIME_BLOCK', assigned_date: null, is_scheduled: true, status: 'COMPLETED', priority: 'MEDIUM', recurrence_type: 'WEEKLY', mindset_prompt: 'Review the day. What went well?', actual_start: isoAt(-2, 21, 0), actual_end: isoAt(-2, 21, 15) },
  );
  logs.push(
  ...
  activities.push(
    { id: uuid(), title: 'Celebrating Journal', start_time: isoAt(-1, 9, 0), duration_minutes: 20, category_id: 'sys-personal', activity_type: 'TIME_BLOCK', assigned_date: null, is_scheduled: true, status: 'COMPLETED', priority: 'MEDIUM', recurrence_type: 'WEEKLY', mindset_prompt: 'Grateful for the small wins this week.', actual_start: isoAt(-1, 9, 0), actual_end: isoAt(-1, 9, 20) },
    ...
    { id: uuid(), title: 'Leisure activities', start_time: isoAt(-1, 18, 0), duration_minutes: 60, category_id: 'sys-rest', activity_type: 'TIME_BLOCK', assigned_date: null, is_scheduled: true, status: 'COMPLETED', priority: 'LOW', recurrence_type: 'DAILY', mindset_prompt: 'This is one of my first callings. Just enjoy it.', actual_start: isoAt(-1, 18, 0), actual_end: isoAt(-1, 19, 0) },
  ...
  activities.push(
    { id: uuid(), title: 'Morning water', start_time: isoAt(0, 7, 57), duration_minutes: 10, category_id: 'sys-personal', activity_type: 'TIME_BLOCK', assigned_date: null, is_scheduled: true, status: 'COMPLETED', priority: 'MEDIUM', recurrence_type: 'WEEKLY', mindset_prompt: 'Hydrate before anything. Start the day clean.', actual_start: isoAt(0, 7, 57), actual_end: isoAt(0, 8, 7) },
    { id: uuid(), title: 'Sunlight', start_time: isoAt(0, 9, 0), duration_minutes: 15, category_id: 'sys-health', activity_type: 'TIME_BLOCK', assigned_date: null, is_scheduled: true, status: 'COMPLETED', priority: 'HIGH', recurrence_type: 'WEEKLY', mindset_prompt: '15 minutes of warmth. Let the light reset your body.', actual_start: isoAt(0, 9, 0), actual_end: isoAt(0, 9, 15) },
    ...
    { id: uuid(), title: 'Leisure activities', start_time: isoAt(0, 15, 0), duration_minutes: 60, category_id: 'sys-rest', activity_type: 'TIME_BLOCK', assigned_date: null, is_scheduled: true, status: 'PLANNED', priority: 'LOW', recurrence_type: 'DAILY', mindset_prompt: 'This is one of my first callings. Just enjoy it.', actual_start: null, actual_end: null },
    ...
    { id: uuid(), title: 'Love/care with bhabhi', start_time: isoAt(0, 17, 0), duration_minutes: 30, category_id: 'cust-family', activity_type: 'TIME_BLOCK', assigned_date: null, is_scheduled: true, status: 'PLANNED', priority: 'HIGH', recurrence_type: 'WEEKLY', mindset_prompt: 'Be present. Listen. Don\'t give advice.', actual_start: null, actual_end: null },
    ...
    { id: uuid(), title: 'Celebrating Journal', start_time: isoAt(0, 20, 30), duration_minutes: 20, category_id: 'sys-personal', activity_type: 'TIME_BLOCK', assigned_date: null, is_scheduled: true, status: 'PLANNED', priority: 'MEDIUM', recurrence_type: 'WEEKLY', mindset_prompt: 'Grateful for the small wins this week.', actual_start: null, actual_end: null },
    { id: uuid(), title: 'Check routine before sleep', start_time: isoAt(0, 21, 30), duration_minutes: 15, category_id: 'sys-personal', activity_type: 'TIME_BLOCK', assigned_date: null, is_scheduled: true, status: 'PLANNED', priority: 'MEDIUM', recurrence_type: 'WEEKLY', mindset_prompt: 'Review the day. What went well?', actual_start: null, actual_end: null },
  );
  logs.push(
  ...
  // ─── Tomorrow: Tuesday ───
  activities.push(
    { id: uuid(), title: 'Morning water', start_time: isoAt(1, 7, 57), duration_minutes: 10, category_id: 'sys-personal', activity_type: 'TIME_BLOCK', assigned_date: null, is_scheduled: true, status: 'PLANNED', priority: 'MEDIUM', recurrence_type: 'WEEKLY', mindset_prompt: 'Hydrate before anything. Start the day clean.', actual_start: null, actual_end: null },
    { id: uuid(), title: 'Self love', start_time: isoAt(1, 9, 0), duration_minutes: 30, category_id: 'sys-personal', activity_type: 'TIME_BLOCK', assigned_date: null, is_scheduled: true, status: 'PLANNED', priority: 'HIGH', recurrence_type: 'WEEKLY', mindset_prompt: 'I am enough and I love the way I am.', actual_start: null, actual_end: null },
    ...
    { id: uuid(), title: 'Sankalp work', start_time: isoAt(1, 10, 30), duration_minutes: 150, category_id: 'sys-deep-work', activity_type: 'TIME_BLOCK', assigned_date: null, is_scheduled: true, status: 'PLANNED', priority: 'HIGH', recurrence_type: 'WEEKLY', mindset_prompt: 'Serious about intent, playful execution.', actual_start: null, actual_end: null },
    { id: uuid(), title: 'Create happy memories', start_time: isoAt(1, 16, 0), duration_minutes: 60, category_id: 'sys-personal', activity_type: 'TIME_BLOCK', assigned_date: null, is_scheduled: true, status: 'PLANNED', priority: 'MEDIUM', recurrence_type: 'WEEKLY', mindset_prompt: 'Make someone smile today.', actual_start: null, actual_end: null },
  ...
  // ─── Day +2: Wednesday ───
  activities.push(
    { id: uuid(), title: 'Waking up practise', start_time: isoAt(2, 9, 0), duration_minutes: 20, category_id: 'sys-personal', activity_type: 'TIME_BLOCK', assigned_date: null, is_scheduled: true, status: 'PLANNED', priority: 'MEDIUM', recurrence_type: 'WEEKLY', mindset_prompt: 'Feel the energy. Affirmations of loving self.', actual_start: null, actual_end: null },
    { id: uuid(), title: 'Bhaiya meet', start_time: isoAt(2, 15, 0), duration_minutes: 60, category_id: 'cust-family', activity_type: 'TIME_BLOCK', assigned_date: null, is_scheduled: true, status: 'PLANNED', priority: 'HIGH', recurrence_type: 'WEEKLY', mindset_prompt: 'Be equal. No one is above or below.', actual_start: null, actual_end: null },
  ...
  // ─── Day +3: Thursday ───
  activities.push(
    { id: uuid(), title: 'Sankalp work', start_time: isoAt(3, 10, 0), duration_minutes: 180, category_id: 'sys-deep-work', activity_type: 'TIME_BLOCK', assigned_date: null, is_scheduled: true, status: 'PLANNED', priority: 'HIGH', recurrence_type: 'WEEKLY', mindset_prompt: 'Serious about intent, playful execution.', actual_start: null, actual_end: null },
    { id: uuid(), title: 'Humour Writing', start_time: isoAt(3, 17, 0), duration_minutes: 45, category_id: 'sys-creative', activity_type: 'TIME_BLOCK', assigned_date: null, is_scheduled: true, status: 'PLANNED', priority: 'MEDIUM', recurrence_type: 'WEEKLY', mindset_prompt: 'Make situations lighter. Improv.', actual_start: null, actual_end: null },
  ...
  // ─── Day +4: Friday ───
  activities.push(
    { id: uuid(), title: 'Sankalp work', start_time: isoAt(4, 10, 0), duration_minutes: 120, category_id: 'sys-deep-work', activity_type: 'TIME_BLOCK', assigned_date: null, is_scheduled: true, status: 'PLANNED', priority: 'HIGH', recurrence_type: 'WEEKLY', mindset_prompt: 'Serious about intent, playful execution.', actual_start: null, actual_end: null },
    ...
    { id: uuid(), title: 'Celebrating Journal', start_time: isoAt(4, 20, 0), duration_minutes: 20, category_id: 'sys-personal', activity_type: 'TIME_BLOCK', assigned_date: null, is_scheduled: true, status: 'PLANNED', priority: 'MEDIUM', recurrence_type: 'WEEKLY', mindset_prompt: 'Grateful for the small wins this week.', actual_start: null, actual_end: null },
  );
  ...
  activities.push(
    ...
    { id: uuid(), title: 'Check routine before sleep', start_time: isoAt(5, 21, 0), duration_minutes: 15, category_id: 'sys-personal', activity_type: 'TIME_BLOCK', assigned_date: null, is_scheduled: true, status: 'PLANNED', priority: 'MEDIUM', recurrence_type: 'WEEKLY', mindset_prompt: 'Review the day. What went well?', actual_start: null, actual_end: null },
  );

  // ─── Day +6: Sunday ───
  activities.push(
    { id: uuid(), title: 'Celebrating Journal', start_time: isoAt(6, 9, 0), duration_minutes: 20, category_id: 'sys-personal', activity_type: 'TIME_BLOCK', assigned_date: null, is_scheduled: true, status: 'PLANNED', priority: 'MEDIUM', recurrence_type: 'WEEKLY', mindset_prompt: 'Grateful for the small wins this week.', actual_start: null, actual_end: null },
  ...
  activities.push(
    { id: uuid(), title: 'Morning water', start_time: isoAt(7, 7, 57), duration_minutes: 10, category_id: 'sys-personal', activity_type: 'TIME_BLOCK', assigned_date: null, is_scheduled: true, status: 'PLANNED', priority: 'MEDIUM', recurrence_type: 'WEEKLY', mindset_prompt: 'Hydrate before anything. Start the day clean.', actual_start: null, actual_end: null },
    { id: uuid(), title: 'Sunlight', start_time: isoAt(7, 9, 0), duration_minutes: 15, category_id: 'sys-health', activity_type: 'TIME_BLOCK', assigned_date: null, is_scheduled: true, status: 'PLANNED', priority: 'HIGH', recurrence_type: 'WEEKLY', mindset_prompt: '15 minutes of warmth. Let the light reset your body.', actual_start: null, actual_end: null },
